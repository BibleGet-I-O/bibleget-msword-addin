...
Partial Public NotInheritable Class BibleGetAddIn
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _BibleGetAddIn As BibleGetAddIn
    ...
    Friend Shared Property BibleGetAddIn() As BibleGetAddIn
        Get
            Return _BibleGetAddIn
        End Get
        Set
            If (_BibleGetAddIn Is Nothing) Then
                _BibleGetAddIn = value
            Else
